    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        ...
        <Card className="glass border-white/5 bg-transparent p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Everything from LAN-first multiplayer games (Mini Strike) to local-first AI (Forge AI) and communication tools (RFL Connect).</p>
        </Card>
      </div>
    </div>
  ),
