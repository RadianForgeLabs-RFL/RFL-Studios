...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "RFL Studios by Radian Forge Labs — the official portal for our apps, games, AI tools and open-source projects." },
      ...
      { property: "og:description", content: "Creating games, apps, AI tools and open software." },
