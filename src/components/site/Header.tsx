    ...
    <header className="sticky top-0 z-40 border-b border-white/5 glass-strong">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4">
        <Link to="/" className="group flex shrink-0 items-center gap-2.5">
          <div className="grid h-9 w-9 place-items-center rounded-xl bg-gradient-brand font-bold text-brand-foreground shadow-glow">
            RFL
          </div>
        ...
        <nav className="hidden items-center gap-1 lg:flex">
          {NAV.map((n) => (
            <Link
              ...
              activeProps={{ className: "rounded-md px-3 py-1.5 text-sm text-foreground bg-white/5" }}
